          ...
          <Reveal key={testimonial.name} delay={index * 0.04} className="h-full" dissolve>
            <figure className="flex h-full flex-col rounded-panel border border-line bg-panel p-2">
              {/* The quote takes the slack so every card's attribution sits on
                  the floor of its cell. Quotes still differ by a line or two, and
                  with the caption following the text directly the three names
                  landed at three different heights across the row. */}
              <blockquote className="prose-body flex-1 leading-relaxed">“{testimonial.quote}”</blockquote>
